...
// PATCH...
schoolingRouter.patch('/:id/deletesch-status', schoolingControllers_1.toggleDeleteSchoolingStatusResponse);
schoolingRouter.patch('/delete_status', schoolingControllers_1.toggleSeveralDeleteSchRecordsResponse);
